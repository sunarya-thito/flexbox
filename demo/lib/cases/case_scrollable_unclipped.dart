...
class CaseUnclippedScrollable extends TestCase {
  @override
  String get name => 'Unclipped Scrollable FlexBox';
  @override
  String get path => 'case_scrollable_unclipped.dart';
  @override
  Widget build() {
    return SizedBox(
      width: 300,
      ...
      child: Box.parent(
        child: FlexBox(
          ...
          verticalOverflow: LayoutOverflow.clip,
