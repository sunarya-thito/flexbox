...
void main() {
  group('Viewport Positioning Tests', () {
    testWidgets('RelativeViewport positioning anchors to viewport', (WidgetTester tester) async {
                ...
                child: FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      ...
                      child: Container(key: Key('viewportChild'), color: Colors.blue),
                    ),
                    // Additional content
                    FlexBoxChild(
                      width: BoxSize.fixed(400),
    ...
    testWidgets('RelativeViewport with percentage positioning', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Container(
                ...
                child: SizedBox(
                  ...
                  child: FlexBox(
                    ...
                    children: [
                      ...
                      FlexBoxChild(
                        left: BoxPosition.relative(0.25), // 25% of viewport width
                        top: BoxPosition.relative(0.5), // 50% of viewport height
                        width: BoxSize.fixed(100),
                        height: BoxSize.fixed(80),
                        horizontalPosition: BoxPositionType.relativeViewport,
                        verticalPosition: BoxPositionType.relativeViewport,
                        child: Container(key: Key('percentViewportChild'), color: Colors.purple),
                      ),
                      // More content
                      FlexBoxChild(
                        width: BoxSize.fixed(600),
      ...
      // Position should be relative to viewport dimensions (600x400)
      expect(child.dx, equals(600 * 0.25)); // 150
      expect(child.dy, equals(400 * 0.5)); // 200
    });

    testWidgets('RelativeViewport vs Relative positioning comparison', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SingleChildScrollView(
                ...
                child: FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      ...
                      child: Container(key: Key('relativeChild'), color: Colors.orange),
                    ),
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relativeViewport,
                      verticalPosition: BoxPositionType.relativeViewport,
                      child: Container(key: Key('viewportRelativeChild'), color: Colors.cyan),
                    ),
                    // More content
                    FlexBoxChild(
                      width: BoxSize.fixed(400),
      ...
      final viewportChild = tester.getTopLeft(find.byKey(Key('viewportRelativeChild')));
    ...
    testWidgets('Viewport positioning with scrolling behavior', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SingleChildScrollView(
                ...
                child: FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relativeViewport,
                      verticalPosition: BoxPositionType.relativeViewport,
                      child: Container(key: Key('scrollViewportChild'), color: Colors.indigo),
                    ),
      ...
      final initialPosition = tester.getTopLeft(find.byKey(Key('scrollViewportChild')));
      ...
      // After scrolling, viewport positioning should maintain viewport reference
      final scrolledPosition = tester.getTopLeft(find.byKey(Key('scrollViewportChild')));
      expect(scrolledPosition.dx, equals(150.0)); // Horizontal should remain the same
      expect(scrolledPosition.dy, equals(100.0)); // Vertical should maintain viewport reference
    });

    testWidgets('Mixed viewport and regular positioning types', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SingleChildScrollView(
                ...
                child: FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relative,
                      verticalPosition: BoxPositionType.relative,
                      child: Container(key: Key('relativeChild'), color: Colors.blue),
                    ),
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relativeViewport,
                      verticalPosition: BoxPositionType.relativeViewport,
                      child: Container(key: Key('viewportChild'), color: Colors.green),
                    ),
                    // Content below
                    FlexBoxChild(
                      width: BoxSize.fixed(500),
    ...
    testWidgets('Viewport positioning with constraints and sizing', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Container(
                ...
                child: SizedBox(
                  ...
                  child: FlexBox(
                    ...
                    children: [
                      ...
                      FlexBoxChild(
                        top: BoxPosition.relative(0.1), // 10% of viewport height
                        left: BoxPosition.relative(0.2), // 20% of viewport width
                        width: BoxSize.flex(1.0),
                        height: BoxSize.fixed(120),
                        horizontalPosition: BoxPositionType.relativeViewport,
                        verticalPosition: BoxPositionType.relativeViewport,
                        child: Container(key: Key('flexViewportChild'), color: Colors.deepPurple),
                      ),
      ...
      final unconstrainedChild = tester.getTopLeft(find.byKey(Key('unconstrainedViewportChild')));

      // FlexViewport child positioned relative to viewport (800x600)
      expect(flexChild.dx, equals(800 * 0.2)); // 160
      expect(flexChild.dy, equals(600 * 0.1)); // 60

      // Unconstrained viewport child positioned from bottom-right
      expect(unconstrainedChild.dx, equals(800 - 150 - 40)); // 610
      expect(unconstrainedChild.dy, equals(600 - 100 - 80)); // 420
    });

    testWidgets('Edge case: Viewport positioning with zero dimensions', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SingleChildScrollView(
                ...
                child: FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relativeViewport,
                      verticalPosition: BoxPositionType.relativeViewport,
                      child: Container(key: Key('zeroWidthChild'), color: Colors.orange),
                    ),
                    ...
                    FlexBoxChild(
                      ...
                      horizontalPosition: BoxPositionType.relativeViewport,
                      verticalPosition: BoxPositionType.relativeViewport,
                      child: Container(key: Key('zeroHeightChild'), color: Colors.cyan),
                    ),
                    // Regular content
                    FlexBoxChild(
                      width: BoxSize.fixed(400),
      ...
      final zeroHeightChild = tester.getSize(find.byKey(Key('zeroHeightChild')));
    ...
    testWidgets('Viewport positioning maintains consistency across layout changes', (WidgetTester tester) async {
                      ...
                      children: [
                        ...
                        FlexBoxChild(
                          ...
                          child: GestureDetector(
                            onTap: () => setState(() => showExtraContent = !showExtraContent),
                            child: Container(key: Key('consistentViewportChild'), color: Colors.blue),
                          ),
                        ),
                        FlexBoxChild(
                          width: BoxSize.fixed(400),
      ...
      // Initial position
      final initialPosition = tester.getTopLeft(find.byKey(Key('consistentViewportChild')));
      ...
      final afterChangePosition = tester.getTopLeft(find.byKey(Key('consistentViewportChild')));
