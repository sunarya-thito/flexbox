...
void main() {
  group('FlexBox Intrinsic Computation Tests', () {
    testWidgets('Intrinsic widget wrapping FlexBox with RatioSize children', (WidgetTester tester) async {
                  ...
                  IntrinsicWidth(
                    child: FlexBox(
                      ...
                      children: [
                        ...
                        FlexBoxChild(
                          width: BoxSize.ratio(2.0), // width = height * 2.0 = 50 * 2.0 = 100
                          height: BoxSize.fixed(50),
                          child: Container(key: Key('ratioWidth'), color: Colors.blue),
                        ),
                      ],
                    ),
                  ),
                  ...
                  IntrinsicHeight(
                    child: FlexBox(
                      ...
                      children: [
                        ...
                        FlexBoxChild(
                          width: BoxSize.fixed(80),
                          height: BoxSize.ratio(1.5), // height = width * 1.5 = 80 * 1.5 = 120
                          child: Container(key: Key('ratioHeight'), color: Colors.orange),
                        ),
                      ],
                    ),
                  ),
      ...
      expect(ratioWidthChild.width, equals(100.0), reason: 'Ratio width child should be 50 * 2.0 = 100');
      expect(ratioWidthChild.height, equals(50.0), reason: 'Height should be fixed at 50');
      ...
      expect(ratioHeightChild.width, equals(80.0), reason: 'Width should be fixed at 80');
      expect(ratioHeightChild.height, equals(120.0), reason: 'Ratio height child should be 80 * 1.5 = 120');
    });

    testWidgets('FlexBox intrinsic computation with FixedSize children', (WidgetTester tester) async {
      ...
      final minIntrinsicHeight = renderBox.getMinIntrinsicHeight(double.infinity);
      final maxIntrinsicHeight = renderBox.getMaxIntrinsicHeight(double.infinity);
      ...
      expect(minIntrinsicWidth, equals(250.0), reason: 'Min intrinsic width should be sum of children');
      expect(maxIntrinsicWidth, equals(250.0), reason: 'Max intrinsic width should be sum of children');
      expect(minIntrinsicHeight, equals(80.0), reason: 'Min intrinsic height should be max of children');
      expect(maxIntrinsicHeight, equals(80.0), reason: 'Max intrinsic height should be max of children');
    });

    testWidgets('FlexBox intrinsic computation with vertical direction', (WidgetTester tester) async {
      late FlexBox flexBox;
      ...
      expect(minIntrinsicWidth, equals(150.0), reason: 'Min intrinsic width should be max of children');
      expect(maxIntrinsicWidth, equals(150.0), reason: 'Max intrinsic width should be max of children');
      expect(minIntrinsicHeight, equals(130.0), reason: 'Min intrinsic height should be sum of children');
      expect(maxIntrinsicHeight, equals(130.0), reason: 'Max intrinsic height should be sum of children');
    });

    testWidgets('FlexBox intrinsic computation with UnconstrainedSize children', (WidgetTester tester) async {
      late FlexBox flexBox;
    ...
    testWidgets('FlexBox intrinsic computation with IntrinsicSize children', (WidgetTester tester) async {
      late FlexBox flexBox;
      ...
      expect(minIntrinsicWidth, greaterThan(0), reason: 'Should compute actual intrinsic width');
      expect(maxIntrinsicWidth, greaterThan(0), reason: 'Should compute actual intrinsic width');
      expect(minIntrinsicHeight, greaterThan(0), reason: 'Should compute actual intrinsic height');
      expect(maxIntrinsicHeight, greaterThan(0), reason: 'Should compute actual intrinsic height');
    });

    testWidgets('FlexBox intrinsic computation with FlexSize children', (WidgetTester tester) async {
      late FlexBox flexBox;
      ...
      expect(minIntrinsicWidth, equals(100.0), reason: 'Should only count non-flex children');
      expect(maxIntrinsicWidth, equals(100.0), reason: 'Should only count non-flex children');
      expect(minIntrinsicHeight, equals(60.0), reason: 'Should only count non-flex children');
      expect(maxIntrinsicHeight, equals(60.0), reason: 'Should only count non-flex children');
    });

    testWidgets('FlexBox intrinsic computation with spacing', (WidgetTester tester) async {
      late FlexBox flexBox;
      ...
      expect(minIntrinsicWidth, equals(320.0), reason: 'Main-axis should include spacing: 100+100+100+10+10');
      expect(maxIntrinsicWidth, equals(320.0), reason: 'Main-axis should include spacing: 100+100+100+10+10');
      expect(minIntrinsicHeight, equals(50.0), reason: 'Cross-axis should be max of children heights');
      expect(maxIntrinsicHeight, equals(50.0), reason: 'Cross-axis should be max of children heights');
    });

    testWidgets('FlexBox intrinsic computation with RatioSize children', (WidgetTester tester) async {
      late FlexBox flexBox;
              ...
              builder: (context) {
                flexBox = FlexBox(
                  ...
                  children: [
                    ...
                    FlexBoxChild(
                      width: BoxSize.ratio(2.0), // width = height * 2.0 = 60 * 2.0 = 120
                      height: BoxSize.fixed(60),
                      child: Container(color: Colors.blue),
                    ),
                    FlexBoxChild(
      ...
      final minIntrinsicWidthUnconstrained = renderBox.getMinIntrinsicWidth(double.infinity);
      final maxIntrinsicWidthUnconstrained = renderBox.getMaxIntrinsicWidth(double.infinity);
      ...
      final minIntrinsicHeightConstrained = renderBox.getMinIntrinsicHeight(100.0);
      final maxIntrinsicHeightConstrained = renderBox.getMaxIntrinsicHeight(100.0);
      
      print('RatioSize - Min intrinsic width (constrained): $minIntrinsicWidthConstrained');
      print('RatioSize - Max intrinsic width (constrained): $maxIntrinsicWidthConstrained');
      print('RatioSize - Min intrinsic width (unconstrained): $minIntrinsicWidthUnconstrained');
      print('RatioSize - Max intrinsic width (unconstrained): $maxIntrinsicWidthUnconstrained');
      print('RatioSize - Min intrinsic height (constrained): $minIntrinsicHeightConstrained');
      print('RatioSize - Max intrinsic height (constrained): $maxIntrinsicHeightConstrained');
      ...
      expect(minIntrinsicWidthConstrained, equals(300.0), reason: 'Constrained: Main-axis should be sum including ratio children: 100+120+80');
      expect(maxIntrinsicWidthConstrained, equals(300.0), reason: 'Constrained: Main-axis should be sum including ratio children: 100+120+80');
      ...
      expect(minIntrinsicWidthUnconstrained, equals(180.0), reason: 'Unconstrained: Ratio children depending on infinite cross-axis should be skipped: 100+0+80');
      expect(maxIntrinsicWidthUnconstrained, equals(180.0), reason: 'Unconstrained: Ratio children depending on infinite cross-axis should be skipped: 100+0+80');
      ...
      expect(minIntrinsicHeightConstrained, equals(150.0), reason: 'Constrained: Cross-axis should be max including ratio children: max(50,60,150)');
      expect(maxIntrinsicHeightConstrained, equals(150.0), reason: 'Constrained: Cross-axis should be max including ratio children: max(50,60,150)');
    });
  });
}
