...
class DemoHomePage extends StatelessWidget {
  final List<DemoItem> demos = [
    ...
    DemoItem(
      ...
      subtitle: 'Elements that size based on content',
      icon: Icons.fit_screen,
      route: '/intrinsic-sizing',
      color: Colors.purple,
    ),
    DemoItem(
      title: 'Unconstrained Sizing',
      subtitle: 'Elements that fill remaining space',
    ...
    DemoItem(
      title: 'Ratio Sizing',
      subtitle: 'Aspect ratio-based element sizing',
    ...
    DemoItem(
      ...
      subtitle: 'Percentage and flex-based positioning',
      icon: Icons.place,
      route: '/relative-positioning',
      color: Colors.indigo,
    ),
    DemoItem(
      title: 'Advanced Layout',
      subtitle: 'Spacing, alignment, and layering',
      icon: Icons.settings,
